...
// 原本只收活動報名與電商的用語,所以服務業的頁面全部被判成「沒有 CTA」。
// 實測:花店的「打電話訂花」、律師的「寄信問我接不接」、接案者的「寄信給我」
// 一個都沒命中。服務業的成交動作就是打電話、寄信、私訊、詢價。
export const CTA_WORDS = [
  // 活動與電商
  "報名","立即","馬上","購買","下單","加入","領取","領券","預約","訂閱","搶購","免費試","報名表",
  // 服務業:直接聯繫
  "打電話","來電","致電","撥打","寄信","來信","寫信","私訊","傳訊","聯絡","聯繫","諮詢",
  // 服務業:詢問與委託
  "洽詢","詢價","報價","估價","洽談","委託","下訂","預訂","訂位",
  // 通訊軟體
  "加 line","加入好友","加賴","加我 line",
];
